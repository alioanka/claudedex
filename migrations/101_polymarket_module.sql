...
VALUES
    ('polymarket_config', 'shadow_mode', 'true', 'boolean',
    ...
    ('polymarket_config', 'live_execution_enabled', 'false', 'boolean',
    ...
    ('polymarket_config', 'gamma_max_requests_per_minute', '30', 'integer',
    ...
    ('polymarket_config', 'chain_id', '137', 'integer',
    ...
    ('polymarket_config', 'poll_interval_s', '60', 'integer',
     'Seconds between Gamma poll/strategy cycles.', NOW(), NOW()),

    ('polymarket_config', 'max_markets_per_poll', '200', 'integer',
    ...
    ('polymarket_config', 'shadow_record_interval_s', '300', 'integer',

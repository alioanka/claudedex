...
if __name__ == "__main__":
    ...
    analyze_main_log("logs/TradingBot.log.4")
    analyze_main_log("logs/TradingBot.log.5")
    analyze_main_log("logs/TradingBot.log.6")
    analyze_main_log("logs/TradingBot.log.7")
    analyze_main_log("logs/TradingBot.log.8")
    analyze_main_log("logs/TradingBot.log.9")
    analyze_main_log("logs/TradingBot.log.10")

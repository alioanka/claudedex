...
if __name__ == "__main__":
    ...
    analyze_main_log("TradingBot.log.3")
    analyze_main_log("TradingBot.log.4")
    analyze_main_log("TradingBot.log.5")
    analyze_main_log("TradingBot.log.6")
    analyze_main_log("TradingBot.log.7")
    analyze_main_log("TradingBot.log.8")
    analyze_main_log("TradingBot.log.9")
    analyze_main_log("TradingBot.log.10")

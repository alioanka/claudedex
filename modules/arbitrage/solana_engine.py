...
# JitoClient lifted to trading/chains/solana/jito_bundle.py (wave-3).
# Both ARBITRAGE and SOLANA spot engines now share the same process-global
# rate-limit counters. Re-exported here to preserve callers like
# `self.jito = JitoClient()` and `JitoClient.is_available()` inside
# `SolanaArbitrageEngine`.
from trading.chains.solana.jito_bundle import JitoClient  # noqa: E402,F401
